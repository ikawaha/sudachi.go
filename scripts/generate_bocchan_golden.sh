...
for MODE in A B C; do
    OUTPUT_FILE="$TEST_DIR/bocchan_golden_mode_${MODE}.txt"
...
echo ""
echo "📋 次のステップ:"
echo "   1. Go版テストを実行: go test -v ./test/regression -run TestBocchanFullComparison"
echo "   2. 比較結果確認: cat test/regression/bocchan_full_comparison_report.json"